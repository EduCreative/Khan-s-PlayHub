  ...
  return (
    <AnimatePresence>
      {visible && achievement && (
        ...
        >
          <div className="glass-card p-4 rounded-[2rem] border-2 border-amber-500/50 bg-slate-900/90 backdrop-blur-xl shadow-[0_0_50px_rgba(245,158,11,0.3)] flex items-center gap-4 overflow-hidden relative">
            ...
            <div className="flex-1">
              ...
              <h4 className="text-lg font-black text-white uppercase italic leading-tight">{achievement.name}</h4>
              <p className="text-xs text-slate-400 font-medium">{achievement.description}</p>
            </div>
